...
const ContactSection = () => {
  return (
    <div className=" bg-white pt-10 md:py-20">
      <div className=" lg:max-w-[1100px]  xl:w-[1423px] m-auto  flex flex-row py-2 justify-center lg:justify-start ">
        <div className=" hidden lg:block w-[150px] relative z-10 ">
          <svg
            className="absolute left-10  xl:-left-28 right-40 xl:h-[600px] lg:w-[950px] xl:w-[1290px] top-0 bottom-0"
          ...
          <h1 className=" absolute  text-white lg:text-5xl xl:text-6xl w-80 -rotate-90 top-32 xl:top-48 -left-16 ">
            Contact Us
          </h1>
          <div className="absolute  top-40 xl:top-48 right-5 lg:left-[39rem] xl:left-[40rem]">
            <ContactInfo customeStyle="text-white" />
          </div>
          <EyeSvg />
        </div>
        <div className="hidden sm:block lg:hidden w-[150px] h-[500px] relative bg-primary rounded-tl-[6rem] rounded-bl-[6rem]">
