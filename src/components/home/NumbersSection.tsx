        ...
        <div className="z-20 w-full h-[600px]  xl:h-[650px]   bg-primary">
          <div className="  flex flex-row gap-5 md:gap-1 justify-center items-center flex-wrap md:flex-nowrap   ">
            ...
            <div className="flex relative flex-row z-20  gap-7">
              ...
              <svg
                className="absolute max-w-36 left-[8rem] right-[4rem] top-36 xxs:left-auto   xxs:max-w-36   xxs:right-36   xs:right-44  md:max-w-44 md:top-36 md:right-36  lg:max-w-52   lg:top-36  lg:right-52 xl:top-36 xl:right-52 z-20   "
                viewBox="0 0 192 214"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
